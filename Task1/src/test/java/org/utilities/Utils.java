...
public class Utils {
    ...
    /**
     * Method to generate a random string that contains the alphabets and numerics of length n
     * @param n : Length of string.
     * @return : Returns the string of n length.
     */
    public static String getRandomAlphaNumericString(int n)
    {
        /*
         * For generate both alphanumeric then use this :
